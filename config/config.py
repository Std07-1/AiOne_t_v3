...
# --- Freeze Corridor (запобіжники критичних зон) ---
FREEZE_CORRIDOR = {
    "ui_time_format": True,  # приймаємо лише SPEC-формат для часу
    "redis_keys_lock": True,  # заборона нових ключів поза config
}
...
__all__ = []  # експортуємо лише за потреби (очищено від SIMPLE_UI_MODE)
